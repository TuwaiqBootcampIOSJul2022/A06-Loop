...
var cpatialsOfStates: [String: String] =  ["Florida": "Tallahassee", "Georgia": "Atlanta", "Idaho": "Boise", "Riyadh": "Riyadh"]
for (key, value) in cpatialsOfStates{
    print("\(value) is the captial of the \(key) state")
    if (key == "Riyadh"){
