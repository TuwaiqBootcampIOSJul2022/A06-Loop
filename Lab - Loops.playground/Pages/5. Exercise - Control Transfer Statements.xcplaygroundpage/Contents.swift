...
var dictionarystates = ["Egypt":"cario","France":"Paris","Germany":"Berlin","SaudiArabia":"Riyadh"]

for (states, capital) in dictionarystates {
    
    if states == "SaudiArabia" && capital == "Riyadh" {
        print("I found my home!")
      break
    }
      print("The Capital of \(states) is \(capital)")
}
