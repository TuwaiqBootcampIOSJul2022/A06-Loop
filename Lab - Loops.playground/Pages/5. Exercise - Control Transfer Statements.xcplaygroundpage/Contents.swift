...
var countrys: [String:String] = ["UAE": "Abu Dhabi" ,"Saudi Arabia": "Riyadh", "Kuwait": "Kuwait"]

for (status,capitals) in countrys {
    
    if status != "Saudi Arabia" && capitals != "Riyadh" {
        print("\(capitals) is capital city of \(status)")
    }else{
